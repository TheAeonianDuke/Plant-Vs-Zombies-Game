...
public class LawnController3 implements Initializable {
    ...
    @FXML
    private Button peashooter_btn, sunflower_btn, walnut_btn, winbtn,losebtn,winbtn2;
...
//                    System.out.println("not colliding");
    ...
    // LawnMower Anim //
//    public void triggerLawnMower(ImageView lawnmower) {
//        movelawnmower=new TranslateTransition(Duration.seconds(3), lawnmower);
//        movelawnmower.setToX(lawnmower.getLayoutX() + 1500);
    ...
    private void Winscreen()
    {
        ...
        winbtn2.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                Pane pane = null;
                try {
                    pane = FXMLLoader.load(getClass().getResource("Lawn4.fxml"));
                } catch (IOException e) {
                    e.printStackTrace();
                }
                Lawn.getChildren().setAll(pane);
